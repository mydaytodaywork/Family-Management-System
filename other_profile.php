<?php
	...
	//checks if comes from login.php
		...
		$info1=getinfo($connection,$_SESSION['username']);
	...
	$query.=" WHERE p.userID=m.userID AND p.userID='{$otherID}' ORDER BY p.time DESC;";
...
<body>
	...
	<div id="menubar">
		<div class="menu active">
			<a href="profile.php"><img src="<?php echo $info1['profile_address'];?>" style="width:18px;height:18px;"/ align="center"><?php echo $info1['firstname'];?></a>
		</div>
		<div class="menu ">
...
<div id="wall-picture"> 
 ...
 <div><button id="sendmessage">Send Message</button></div>
 <div id="left1">
 	<div id="profile_info">
		<div>
			<span>FamilyID:</span>
	...
	<div class="details">
		...
		<div class="dropdown">
			<div class="menu1">
			<a href="service_details.php?others=<?php echo $otherID?>">Service Details</a>
		</div>
		<div class="menu1">
			<a href="banking_details.php?others=<?php echo $otherID?>">Banking Details</a>
		</div>
		<div class="menu1">
			<a href="insurance_details.php?others=<?php echo $otherID?>">Insurance Details</a>
		</div>
		<div class="menu1">
			<a href="vehicle_details.php?others=<?php echo $otherID?>">Vehicle Details</a>
		</div>
		</div>
	</div>
