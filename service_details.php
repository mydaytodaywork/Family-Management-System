...
<div id="update_service" >
	<form method="post" enctype="multipart/form-data">
		...
		<input type="date" name="start_date" placeholder="starting from" />
		<input type="date" name="end_date" placeholder="resign date" /><br />
		upload join letter<input type="file" name="join_letter"  placeholder="upload join letter" /><br />
		upload resign letter<input type="file" name="resign_letter" value="upload resign letter" /><br />
...
<script>
	...
	function load_table()
	{
		$.post("load_table_service.php",{userID:"<?php echo $userID?>",familyID:"<?php echo $familyID?>"},function(data){
